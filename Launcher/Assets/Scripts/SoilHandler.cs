...
public class SoilHandler : MonoBehaviour
{
    ...
    public void Update()
    {
        ...
        if (plantArea.Status != previousStatus)
        {
            ...
            if(plantArea.Status == WORLD.PA_PLANTED && plantArea.PlantObjectReference == null)
            {
                ...
                Seed_Scriptable seedPrep = plantArea.SeedDetails;
                plantSpriteRenderer.sprite = seedPrep.Sprites[0].spr_0;
                ...
                timer.Initialize(seedPrep.Duration);
    ...
    private void PlantGrow(SpriteRenderer spriteRenderer)
    {
        ...
        switch (currentSprite) {
            case 1:
                spriteRenderer.sprite = plantArea.SeedDetails.Sprites[0].spr_1;
                break;
            case 2:
                spriteRenderer.sprite = plantArea.SeedDetails.Sprites[0].spr_2;
                break;
            case 3:
                spriteRenderer.sprite = plantArea.SeedDetails.Sprites[0].spr_3;
                break;
            default:
                break;
        }
    ...
    {
        spriteRenderer.sprite = plantArea.SeedDetails.Sprites[0].spr_4;
    }
